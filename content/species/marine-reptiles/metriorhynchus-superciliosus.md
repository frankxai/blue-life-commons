---
id: species-metriorhynchus-superciliosus
type: species-page
...
sources:
  - url: https://paleobiodb.org/
    ...
    tier: 1
    accessed: "2026-07-16"
  - url: https://www.britannica.com/animal/crocodilian
...
compare:
  - target_id: species-dakosaurus-maximus
    label: "Dakosaurus"
    note: "Related marine crocodylomorph"
  - target_id: leatherback-turtle
    label: "Leatherback turtle"
    note: "Living marine reptile"
outputs:
  website_path: /species/marine-reptiles/metriorhynchus-superciliosus
  github_path: content/species/marine-reptiles/metriorhynchus-superciliosus.md
  map_layer: false
impact:
  claim: Published a sourced deep-time encyclopedia entry for Metriorhynchus superciliosus with concept reconstruction media.
...
media:
  primary:
    asset_id: blc-concept-metriorhynchus-superciliosus-01
    path: public/media/species/metriorhynchus-superciliosus.png
    public_media_url: /media/species/metriorhynchus-superciliosus.png
    source_url: https://github.com/frankxai/blue-life-commons
    original_media_url: /media/species/metriorhynchus-superciliosus.png
    ...
    alt_text: Photoreal concept reconstruction of Metriorhynchus superciliosus. Fully marine crocodylomorph with paddle-like limbs and hypocercal tail — ocean lifestyle, not dinosaur. Cinematic open-ocean lighting.
    qa_status: approved
  video:
    path: public/media/species/metriorhynchus-superciliosus.mp4
    public_media_url: /media/species/metriorhynchus-superciliosus.mp4
    rights_status: concept-reconstruction
...
> **Not a dinosaur.** Fully marine crocodylomorph with paddle-like limbs and hypocercal tail — ocean lifestyle, not dinosaur. Hero media is **AI concept reconstruction** — not fossil evidence.

## At a glance

| Field | Value | Source |
|---|---|---|
| Scientific name | *Metriorhynchus superciliosus* | Paleobiology Database / literature |
| Guild | Marine reptiles | — |
| “Ocean dinosaur?” | **No** | Britannica / UCMP context |
| IUCN | **Extinct** (fossil taxon) | Deep-time convention |
| Period | Middle–Late Jurassic | Paleobiology literature ranges |
| Clade | Thalattosuchia (marine crocodylomorph) | — |

## Identification

Fully marine crocodylomorph with paddle-like limbs and hypocercal tail — ocean lifestyle, not dinosaur. Do not reconstruct with bipedal theropod posture.
