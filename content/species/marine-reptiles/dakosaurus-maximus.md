...
compare:
  - target_id: species-mosasaurus-hoffmannii
    label: "Mosasaurus"
    note: "Different marine reptile guild"
  - target_id: great-white-shark
    label: "Great white shark"
    note: "Living apex analogy"
outputs:
  website_path: /species/marine-reptiles/dakosaurus-maximus
  github_path: content/species/marine-reptiles/dakosaurus-maximus.md
  map_layer: false
impact:
  claim: Published a sourced deep-time encyclopedia entry for Dakosaurus maximus with concept reconstruction media.
...
media:
  primary:
    asset_id: blc-concept-dakosaurus-maximus-01
    path: public/media/species/dakosaurus-maximus.png
    public_media_url: /media/species/dakosaurus-maximus.png
    source_url: https://github.com/frankxai/blue-life-commons
    original_media_url: /media/species/dakosaurus-maximus.png
...
> **Not a dinosaur.** Marine crocodylomorph — not a dinosaur, not a mosasaur; short snout, ziphodont teeth. Hero media is **AI concept reconstruction** — not fossil evidence.

## At a glance

| Field | Value | Source |
|---|---|---|
| Scientific name | *Dakosaurus maximus* | Paleobiology Database / literature |
| Guild | Marine reptiles | — |
| “Ocean dinosaur?” | **No** | Britannica / UCMP context |
| IUCN | **Extinct** (fossil taxon) | Deep-time convention |
| Period | Late Jurassic | Paleobiology literature ranges |
| Clade | Thalattosuchia (marine crocodylomorph) | — |

## Identification

Marine crocodylomorph — not a dinosaur, not a mosasaur; short snout, ziphodont teeth. Do not reconstruct with bipedal theropod posture.
