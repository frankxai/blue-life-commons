---
id: species-plesiosaurus-dolichodeirus
type: species-page
...
sources:
  - url: https://paleobiodb.org/
    ...
    tier: 1
    accessed: "2026-07-16"
  - url: https://www.britannica.com/animal/plesiosaur
...
compare:
  - target_id: species-elasmosaurus-platyurus
    label: "Elasmosaurus"
    note: "Longer-neck elasmosaurid extreme"
  - target_id: leatherback-turtle
    label: "Leatherback turtle"
    note: "Living marine reptile"
outputs:
  website_path: /species/marine-reptiles/plesiosaurus-dolichodeirus
  github_path: content/species/marine-reptiles/plesiosaurus-dolichodeirus.md
  map_layer: false
impact:
  claim: Published a sourced deep-time encyclopedia entry for Plesiosaurus dolichodeirus with concept reconstruction media.
...
media:
  primary:
    asset_id: blc-concept-plesiosaurus-dolichodeirus-01
    path: public/media/species/plesiosaurus-dolichodeirus.png
    public_media_url: /media/species/plesiosaurus-dolichodeirus.png
    source_url: https://github.com/frankxai/blue-life-commons
    original_media_url: /media/species/plesiosaurus-dolichodeirus.png
...
> **Not a dinosaur.** Type plesiosaur — relatively long neck, four flippers, compact body. Hero media is **AI concept reconstruction** — not fossil evidence.

## At a glance

| Field | Value | Source |
|---|---|---|
| Scientific name | *Plesiosaurus dolichodeirus* | Paleobiology Database / literature |
...
Type plesiosaur — relatively long neck, four flippers, compact body. Do not reconstruct with bipedal theropod posture.
