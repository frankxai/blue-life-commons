---
id: species-platecarpus-tympaniticus
type: species-page
...
compare:
  - target_id: species-mosasaurus-hoffmannii
    label: "Mosasaurus"
    note: "Larger mosasaur relative"
  - target_id: great-white-shark
    label: "Great white shark"
    note: "Living apex analogy"
outputs:
  website_path: /species/marine-reptiles/platecarpus-tympaniticus
  github_path: content/species/marine-reptiles/platecarpus-tympaniticus.md
  map_layer: false
impact:
  claim: Published a sourced deep-time encyclopedia entry for Platecarpus tympaniticus with concept reconstruction media.
...
media:
  primary:
    asset_id: blc-concept-platecarpus-tympaniticus-01
    path: public/media/species/platecarpus-tympaniticus.png
    public_media_url: /media/species/platecarpus-tympaniticus.png
    source_url: https://github.com/frankxai/blue-life-commons
    original_media_url: /media/species/platecarpus-tympaniticus.png
