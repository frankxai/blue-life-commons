        ...
        <div className="grid items-center gap-10 overflow-hidden rounded-3xl border border-border bg-abyss text-abyss-foreground lg:grid-cols-2">
          <div className="p-8 sm:p-12">
            ...
            <p className="mt-4 text-pretty leading-relaxed text-abyss-muted">
              Guardian layers live public data over our reviewed knowledge — coral
              bleaching alerts from NOAA Coral Reef Watch and biodiversity
              occurrence data from OBIS. Facts appear only when the source responds.
            </p>
            <div className="mt-8">
